...
<head>
    ...
    <title>Built Gym| View Plan</title>
				...
				<tbody>
					...
					if (mysqli_affected_rows($con) != 0) {
					    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
					        ...
					        echo '<td><form action="del_plan.php" method="post" onSubmit="return ConfirmDelete();">
							<input type="hidden" name="name" value="' . $msgid .'"/>
							<input type="submit" id="button1" value="Confirm" class="a1-btn a1-orange"/></form></td></tr>';
